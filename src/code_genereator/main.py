...
class SoftwareDevFlow(Flow[DevelopmentState]):
    ...
    def run_engineering(self) -> DevelopmentState:
        ...
        print("\n✅ Engineering complete! All code tiers implemented.")
        print("-" * 60)
...
def kickoff():
    ...
    try:
        ...
        print("\n Generated Artifacts:")
        print(f"  - Plan: {'✅' if result.plan else '❌'}")
        print(f"  - Database: {'✅' if result.database_code else '❌'}")
        print(f"  - Backend: {'✅' if result.backend_code else '❌'}")
        print(f"  - Frontend: {'✅' if result.frontend_code else '❌'}")
        print(f"  - Report: {'✅' if result.final_report else '❌'}")
        print("\n" + "=" * 60)
